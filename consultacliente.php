...
?>
Nome:<br/>
<input type="text" value="<?php echo $campos["nome"]?>"disabled><br/>
Idade:<br/>
<input type="text" value="<?php echo $campos["idade"]?>"disabled><br/>
Email:<br/>
<input type="text" value="<?php echo $campos["email"]?>"disabled><br/>
...
?>
<a href="deletarcliente.php?id=<?php echo $campos['codigo']?>">
<a href="">Excluir</a>
<a href="">Alterar></a>
